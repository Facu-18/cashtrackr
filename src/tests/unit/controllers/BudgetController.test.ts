...
// Mockear el modelo Budget completo
...
describe('BudgetController.getAll', () => {
    ...
    it('should retrieve 2 budgets for user by ID 1', async () => {
    ...
    it('should retrieve 1 budgets for user by ID 2', async () => {
        const req = createRequest({
            method: 'GET',
            url: '/api/budgets',
            user: { id: 2 },
    ...
    it('should retrieve 0 budgets for user by ID 15', async () => {
        const req = createRequest({
            method: 'GET',
            url: '/api/budgets',
            user: { id: 15 },
...
describe('BudgetController.create', () => {
    ...
    it('should handle errors when create budgets', async () => {
        ...
        expect(res.statusCode).toBe(500)
        expect(data).toEqual({error: 'Error al crear el presupuesto'})
...
describe('BudgetController.updateById', ()=>{
    it('should update the budgets and return succes message', async()=>{
        const budgetMock = {
...
describe('BudgetController.deleteById', ()=>{
    it('should delete the budgets and return succes message', async()=>{
        const budgetMock = {
